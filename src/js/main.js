...
const translations = {
    pt: {
        app_title: 'Calculadora do Sono',
        label_mode: 'DORMIR / ACORDAR',
        option_bedtime: 'IR PARA A CAMA',
        option_wake: 'ACORDAR',
        option_sleep: 'DORMIR',
        label_time: 'HORA',
        btn_calculate: 'CALCULAR',
        th_cycles: 'Ciclos',
        th_sleep_time: 'Tempo de sono',
        th_bedtime: 'Hora de ir para a cama',
        th_sleep: 'Hora de dormir',
        th_wake: 'Hora de acordar',
        empty_table: 'Selecione os horários e pressione o botão CALCULAR.',
        theme_light: '☀️ Claro',
        theme_dark: '🌙 Escuro',
        theme_auto: '🌞 Auto',
    },
    es: {
        app_title: 'Calculadora del Sueño',
        label_mode: 'DORMIR / DESPERTAR',
        option_bedtime: 'IR A LA CAMA',
        option_wake: 'DESPERTAR',
        option_sleep: 'DORMIR',
        label_time: 'HORA',
        btn_calculate: 'CALCULAR',
        th_cycles: 'Ciclos',
        th_sleep_time: 'Tiempo de sueño',
        th_bedtime: 'Hora de ir a la cama',
        th_sleep: 'Hora de dormir',
        th_wake: 'Hora de despertar',
        empty_table: 'Seleccione los horarios y presione el botón CALCULAR.',
        theme_light: '☀️ Claro',
        theme_dark: '🌙 Oscuro',
        theme_auto: '🌞 Auto',
    },
    en: {
        app_title: 'Sleep Calculator',
        label_mode: 'SLEEP / WAKE',
        option_bedtime: 'GO TO BED',
        option_wake: 'WAKE UP',
        option_sleep: 'SLEEP',
        label_time: 'TIME',
        btn_calculate: 'CALCULATE',
        th_cycles: 'Cycles',
        th_sleep_time: 'Sleep duration',
        th_bedtime: 'Time to go to bed',
        th_sleep: 'Time to fall asleep',
        th_wake: 'Wake-up time',
        empty_table: 'Select the times and press CALCULATE.',
        theme_light: '☀️ Light',
        theme_dark: '🌙 Dark',
        theme_auto: '🌞 Auto',
    },
